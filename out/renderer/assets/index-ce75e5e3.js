...
const specificFill = "_specificFill_65qoy_1";
const characterLimit = "_characterLimit_65qoy_5";
const exceeded = "_exceeded_65qoy_12";
const svgColor = "_svgColor_65qoy_17";
const scss$e = {
  specificFill,
  characterLimit,
  exceeded,
...
function CharacterLimit(props) {
  const [counterZero, setCounterZero] = reactExports.useState(false);
  const remainingCharacters = props.maxLength - props.value.length;
  reactExports.useEffect(() => {
    setCounterZero(remainingCharacters < 0);
  }, [remainingCharacters]);
  const svgColor2 = classNames(scss$e.svgColor, {
    [scss$e.exceeded]: counterZero
  });
  const characterLimitClass = classNames(scss$e.characterLimit, {
    [scss$e.exceeded]: counterZero
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: svgColor2, children: [
    props.svg,
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: characterLimitClass, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: remainingCharacters }) })
  ] });
}
const compost = "_compost_i33um_1";
const scss$d = {
  compost
};
function CharacterLimitMainText(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$d.compost, children: props.module.map((module) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    CharacterLimit,
    {
...
const textAreaContainer = "_textAreaContainer_60zt1_1";
const mainTitle = "_mainTitle_60zt1_5";
const textArea = "_textArea_60zt1_1";
const scss$c = {
  textAreaContainer,
  mainTitle,
  textArea
...
const inputContainer = "_inputContainer_189qv_1";
const wrapper$1 = "_wrapper_189qv_7";
const copyTextContainer = "_copyTextContainer_189qv_11";
const scss$b = {
  inputContainer,
  wrapper: wrapper$1,
  copyTextContainer
...
const ComposerEditor = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$b.inputContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$b.wrapper, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTextArea, { onTextChange: handleInputChange }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CharacterLimitMainText, { module }) })
  ] }) });
};
const consoleLogger = {
  type: "logger",
...
const translation$1 = {
  "We have a lot of work": "We have a lot of work"
};
const ENUS = {
  translation: translation$1
};
const translation = {
  "We have a lot of work": "Nos temos muito trabalho"
};
const PTBR = {
  translation
};
...
const wrapper = "_wrapper_dvei9_1";
const innerHeader = "_innerHeader_dvei9_5";
const mainContent = "_mainContent_dvei9_13";
const mainText = "_mainText_dvei9_13";
const content = "_content_dvei9_42";
const textInput = "_textInput_dvei9_48";
const contentBotTop = "_contentBotTop_dvei9_58";
const contentBotBot = "_contentBotBot_dvei9_63";
const scss$a = {
  wrapper,
  innerHeader,
  mainContent,
...
function MainComposer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$a.wrapper, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$a.innerHeader, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$a.mainContent, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: scss$a.mainText, children: "Main Content" }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$a.content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$a.textInput, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ComposerEditor, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$a.contentBot, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$a.contentBotTop, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "content-bot-top" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$a.contentBotBot, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "content-bot-bot" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: t2("We have a lot of work") })
        ] })
      ] })
    ] })
  ] });
...
const button = "_button_10yzl_1";
const buttonSelected = "_buttonSelected_10yzl_2";
const hidden = "_hidden_10yzl_27";
const imagePlaceholder = "_imagePlaceholder_10yzl_31";
const imageSelected = "_imageSelected_10yzl_32";
const scss$9 = {
  button,
  buttonSelected,
  hidden,
...
const emptyInputGrey = "" + new URL("imageEmptyGray-ed9587a5.svg", import.meta.url).href;
function InputMedia(props) {
  const fileInputRef = reactExports.useRef(null);
  const inputClasses = classNames(scss$9.button, {
    [scss$9.buttonSelected]: props.files
  });
  ...
  const renderEmptyImagePlaceholder = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: emptyInputGrey,
      alt: "image placeholder",
      className: scss$9.imagePlaceholder
    }
  );
  const renderImage = (file) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: URL.createObjectURL(file),
      alt: `uploaded image ${file.name}`,
      className: scss$9.imageSelected
    }
  );
  const renderVideo = (file) => /* @__PURE__ */ jsxRuntimeExports.jsx("video", { controls: true, className: scss$9.imageSelected, children: /* @__PURE__ */ jsxRuntimeExports.jsx("source", { src: URL.createObjectURL(file), type: file.type }) });
  const renderMedia = () => {
    if (!props.files)
      return;
    return props.files.type.includes("image") ? renderImage(props.files) : renderVideo(props.files);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: inputClasses, onClick: handleInputClick, children: [
...
const manyMediaContainer = "_manyMediaContainer_1udy8_1";
const imageGroup = "_imageGroup_1udy8_7";
const removeButton = "_removeButton_1udy8_12";
const imageOverlay = "_imageOverlay_1udy8_33";
const scss$8 = {
  manyMediaContainer,
  imageGroup,
  removeButton,
...
function MediaGroup({ media, onImageChange, onRemove }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$8.imageGroup, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$8.imageContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      InputMedia,
      {
        files: media.file,
...
function MediaInputs() {
  const [medias, setMedias] = reactExports.useState([]);
  const addMedia = (files) => {
    setMedias([...medias, ...files]);
  };
  const removeMedia = (id2) => {
    const list = [...medias];
    const indexToRemove = list.findIndex((item) => item.id === id2);
    if (indexToRemove !== -1) {
      list.splice(indexToRemove, 1);
    }
    setMedias(list);
  };
  const updateMedia = (files, id2) => {
    const list = [...medias];
    const indexToUpdate = list.findIndex((item) => item.id === id2);
    if (indexToUpdate !== -1) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$8.manyMediaContainer, "data-testid": "manyMediaInputs", children: [
    medias.map((media) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      MediaGroup,
      {
        media,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputMedia, { onChange: addMedia })
  ] });
}
const buttonWrapper = "_buttonWrapper_bzm4a_1";
const submitButtonPostNow = "_submitButtonPostNow_bzm4a_7";
const submitButtonPostLater = "_submitButtonPostLater_bzm4a_8";
const scss$7 = {
  buttonWrapper,
  submitButtonPostNow,
  submitButtonPostLater
};
function SubmitButton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$7.buttonWrapper, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: scss$7.submitButtonPostNow, children: "Post Now" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: scss$7.submitButtonPostLater, children: "Post Later" })
  ] });
}
const savBarWrapper = "_savBarWrapper_s5ktk_1";
const scss$6 = {
  savBarWrapper
};
function SavBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$6.savBarWrapper, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", children: "+ Save as draft" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubmitButton, {})
  ] });
}
const header = "_header_x3nhi_1";
const scss$5 = {
  header
};
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: scss$5.header, children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: scss$5.nav, children: "Header" }) });
}
const container = "_container_1xpax_1";
const containerError = "_containerError_1xpax_8";
const containerFocus = "_containerFocus_1xpax_11";
const containerFilled = "_containerFilled_1xpax_14";
const inputWrapper = "_inputWrapper_1xpax_17";
const label = "_label_1xpax_25";
const labelAnimate = "_labelAnimate_1xpax_35";
const labelError = "_labelError_1xpax_40";
const labelFilled = "_labelFilled_1xpax_43";
const input = "_input_1xpax_17";
const fieldset = "_fieldset_1xpax_62";
const fieldsetFocus = "_fieldsetFocus_1xpax_73";
const fieldsetError = "_fieldsetError_1xpax_76";
const legend = "_legend_1xpax_79";
const legendFocus = "_legendFocus_1xpax_89";
const legendFilled = "_legendFilled_1xpax_92";
const legendTitle = "_legendTitle_1xpax_95";
const iconLeft = "_iconLeft_1xpax_99";
const iconRight = "_iconRight_1xpax_107";
const errorWrapper = "_errorWrapper_1xpax_120";
const errorMessage = "_errorMessage_1xpax_127";
const scss$4 = {
  container,
  containerError,
  containerFocus,
...
const alertIcon = "" + new URL("alertIcon-346b882c.svg", import.meta.url).href;
const leftIcon = "" + new URL("leftIcon-da8590a4.svg", import.meta.url).href;
const rightIcon = "" + new URL("rightIcon-7f5ba8dc.svg", import.meta.url).href;
function InputSearch(props, ref) {
  const [value, setValue] = reactExports.useState("");
  const labelClass = [scss$4.label];
  const inputClass = [scss$4.input];
  const legendClass = [scss$4.legend];
  const fieldsetClass = [scss$4.fieldset];
  const containerClass = [scss$4.container];
  const [isFocused, setIsFocused] = reactExports.useState(false);
  const IconAlert = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: scss$4.icon, src: alertIcon });
  };
  const IconRight = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: rightIcon });
  };
  const handleIcons = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: scss$4.iconRight,
      "data-testid": "clear-button",
      onClick: handleClear,
      children: props.error ? /* @__PURE__ */ jsxRuntimeExports.jsx(IconAlert, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(IconRight, {})
    }
  );
  const handleClear = () => {
  ...
  const renderErrorMessage = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$4.errorWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: scss$4.errorMessage, children: props.errorMessage }) });
  ...
  const handleFocusedStyles = () => {
    fieldsetClass.push(scss$4.fieldsetFocus);
    legendClass.push(scss$4.legendFocus);
    labelClass.push(scss$4.labelAnimate);
    containerClass.push(scss$4.containerFocus);
  };
  const handleErrorStyles = () => {
    fieldsetClass.push(scss$4.fieldsetError);
    containerClass.push(scss$4.containerError);
    labelClass.push(scss$4.labelError);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classNames(containerClass), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$4.inputWrapper, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: props.name, className: classNames(labelClass), children: props.placeholder }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$4.iconLeft, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: leftIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          required: true,
      ...
      value && handleIcons(),
      /* @__PURE__ */ jsxRuntimeExports.jsx("fieldset", { "eria-hidden": "true", className: classNames(fieldsetClass), children: /* @__PURE__ */ jsxRuntimeExports.jsx("legend", { className: classNames(legendClass), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: scss$4.legendTitle, children: props.placeholder }) }) })
    ] }),
    props.error && renderErrorMessage()
  ] });
}
const InputSearch$1 = reactExports.forwardRef(InputSearch);
const searchClueContainer = "_searchClueContainer_1lfdu_1";
const spanSearchClue = "_spanSearchClue_1lfdu_14";
const searchWord = "_searchWord_1lfdu_18";
const clearButton = "_clearButton_1lfdu_21";
const scss$3 = {
  searchClueContainer,
  spanSearchClue,
  searchWord,
...
function SearchClue(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$3.searchClueContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: scss$3.spanSearchClue, children: [
      label2,
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: scss$3.searchWord, children: props.value })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: scss$3.clearButton, onClick: handleClearClick, children: "Clean" })
  ] });
}
const sidebar = "_sidebar_1ax42_1";
const titleContainer = "_titleContainer_1ax42_10";
const dotSvg = "_dotSvg_1ax42_31";
const itemsContainer = "_itemsContainer_1ax42_34";
const sidebarMain = "_sidebarMain_1ax42_48";
const scss$2 = {
  sidebar,
  titleContainer,
  dotSvg,
...
function Sidebar() {
  const [value, setValue] = reactExports.useState("");
  const inputSearchRef = reactExports.useRef(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: scss$2.sidebar, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$2.titleContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Select Social Media" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$2.sidebarMain, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        InputSearch$1,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$2.itemsContainer, children: [
        "Item 1 ",
...
const home = "_home_sa7fq_1";
const navBar = "_navBar_sa7fq_6";
const logo = "_logo_sa7fq_16";
const mainContainer$1 = "_mainContainer_sa7fq_23";
const gridContainer$1 = "_gridContainer_sa7fq_31";
const gridSwitches$1 = "_gridSwitches_sa7fq_40";
const gridInput$1 = "_gridInput_sa7fq_44";
const gridTabs$1 = "_gridTabs_sa7fq_50";
const scss$1 = {
  home,
  navBar,
  logo,
  mainContainer: mainContainer$1,
  gridContainer: gridContainer$1,
  gridSwitches: gridSwitches$1,
  gridInput: gridInput$1,
  gridTabs: gridTabs$1
};
const Home = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$1.mainContainer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$1.gridContainer, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$1.gridSwitches, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: scss$1.gridInput, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MainComposer, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MediaInputs, {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss$1.gridTabs })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SavBar, {})
    ] })
  ] });
};
const mainContainer = "_mainContainer_y7zvn_1";
const gridContainer = "_gridContainer_y7zvn_10";
const gridSwitches = "_gridSwitches_y7zvn_20";
const gridInput = "_gridInput_y7zvn_25";
const gridTabs = "_gridTabs_y7zvn_30";
const scss = {
  mainContainer,
  gridContainer,
  gridSwitches,
...
const base = "";
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: scss.app, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {}) }) }) }) });
}
