...
describe('SocialAccordion', () => {
  describe('when initilize', () => {
    it('renders the component', () => {
      render(<SocialAccordion error={false} accountList={mockList} socialMediaName="facebook" />)
    ...
    it('shows the error on screen if error={true}', () => {
      render(<SocialAccordion error accountList={[]} socialMediaName="facebook" />)
  ...
  describe('when click', () => {
    it('closes the accordion', async () => {
      ...
      await waitFor(() => expect(screen.queryByText(/jhon doe/i)).not.toBeInTheDocument())
    })
  })

  describe('account list', () => {
    it('renders with zero if list is empty', () => {
      render(<SocialAccordion error={false} accountList={[]} socialMediaName="facebook" />)
